 ...
 */
public class BuscarListaOrdemServicoAsync extends AsyncTask<String, Integer,EntidadeRetornoOS> {
    ...
    public BuscarListaOrdemServicoAsync(Context context, Action action){
