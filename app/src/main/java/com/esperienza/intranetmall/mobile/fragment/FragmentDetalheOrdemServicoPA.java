 ...
 */
public class FragmentDetalheOrdemServicoPA extends Fragment{
    ...
    public FragmentDetalheOrdemServicoPA(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_ordemservicopa,
                container, false);
    ...
    public void init()
    {
        ...
        textViewtelefone.setText(os.getTelefone().equals("anyType{}")?"":os.getTelefone());
        textViewservico.setText(getServico(os.getIdtipo()));
        textViewdetalhesservico.setText(os.getDescricao());
                ...
                if(result!=null)
                {
                    if(result.getIdcomentario()>0)
                    {
                        ...
                        //AprovadoresOSDAO.getNewInstance().save(apr);
                            ...
                            servicoList.addAll(FragmentPesquisaAvancada.mDataset);
                            for (OrdemServico os2:FragmentPesquisaAvancada.mDataset)
                            {
                        ...
                        {
                            e.printStackTrace();
                            FragmentPesquisaAvancada.flag=true;
                        }
                    ...
                    {
                        FragmentPesquisaAvancada.flag=false;
