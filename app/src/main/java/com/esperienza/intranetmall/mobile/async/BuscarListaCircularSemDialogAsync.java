...
/**
 * Created by ThinkPad on 24/03/2016.
 */
public class BuscarListaCircularSemDialogAsync extends AsyncTask<String, Integer,EntidadeCircular> {
...
//private ProgressDialog dialog;
    ...
    public BuscarListaCircularSemDialogAsync(Context context, Action action){
