...
public class RoundedImageView extends ImageView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        //paint.setARGB(255, 233, 30, 99);
        //paint.setColor(getResources().getColor(R.color.md_pink_500));
         //canvas.drawCircle(400, 400, 100, paint);
        //canvas.drawCircle(toPixels(getContext(), 200), toPixels(getContext(),200),toPixels(getContext(),200),paint);
