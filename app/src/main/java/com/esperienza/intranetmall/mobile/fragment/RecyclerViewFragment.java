...
import com.esperienza.intranetmall.mobile.activity.SwipeDismissRecyclerViewTouchListener;
...
public class RecyclerViewFragment extends Fragment  {
    ...
    //protected Spinner spinnerStatusFnc;
    ...
    private void initDataset(int flag) {
        ...
        switch (flag)
        {
            case 0:
                ...
                {
                    mDataset = fncdao.listFuncionariosShop(AppHelper.getIdShop());
                }
                else
                {
        ...
        new EnvioFuncionarioAsync(this.getActivity(), new EnvioFuncionarioAsync.Action() {
            ...
            public void postExecute(String result) {
                ...
                if(result!=null||result.equals("0"))
                {
                    if(result.equals("-1"))
                    {
                        Toast.makeText(getActivity(),"Não é possível cadastrar funcionário com o mesmo CPF.",Toast.LENGTH_SHORT).show();
                        return;
                    }
                    else
                    {
