 ...
 */
public class ListaOrdemServicoAdapter extends RecyclerView.Adapter<ListaOrdemServicoAdapter.ViewHolder> {
    ...
    public ListaOrdemServicoAdapter(Context context,List<OrdemServico> dataSet)
    {
        this.context=context;
        this.mDataSet = dataSet;
    }
    public ListaOrdemServicoAdapter(List<OrdemServico> dataSet)
    {
        this.mDataSet = dataSet;
    }

    public ListaOrdemServicoAdapter(){}
